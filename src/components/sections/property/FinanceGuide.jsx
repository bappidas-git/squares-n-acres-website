...
const FinanceGuide = ({ price = 0, property = null, savedUserDetails, onLeadCaptured }) => {
  ...
  const validateAssessment = useCallback(() => {
    ...
    if (!assessmentData.monthlyIncome) errors.monthlyIncome = 'Select your income range';
  ...
  const scrollToResult = useCallback(() => {
    setTimeout(() => {
      ...
      if (financeSection) {
        ...
        const top = financeSection.getBoundingClientRect().top + window.scrollY - offset;
  ...
  const validateModalForm = useCallback(() => {
    ...
    if (!modalFormData.monthlyIncome) errors.monthlyIncome = 'Select your income range';
  ...
  const handleModalSubmit = useCallback(
    ...
    [modalFormData, eligibilityModal.bank, property?.id, price, validateModalForm, onLeadCaptured]
  );
        ...
        <div className={styles.formGrid2} style={{ marginTop: '16px' }}>
          <div className={styles.formField}>
            ...
            {errors.employmentYears && (
              <span className={styles.fieldError}>{errors.employmentYears}</span>
            )}
          </div>
        </div>
      </div>
        ...
        {data.existingEmi && data.existingEmi !== '0' && (
          <div className={styles.formGrid2} style={{ marginTop: '16px' }}>
            <div className={styles.formField}>
              ...
              {errors.emiTenure && <span className={styles.fieldError}>{errors.emiTenure}</span>}
            </div>
          </div>
        )}
          ...
          <div className={styles.formField}>
            ...
            <div className={styles.rangeLabels}>
              ...
              <span className={styles.rangeCurrentVal}>
                {formatCurrency((price * (parseInt(data.downPayment) || 0)) / 100)}
              </span>
              <span>50%</span>
            </div>
          </div>
      ...
      <div className={styles.formSection}>
        ...
        <div className={styles.formGrid2}>
          ...
          {data.hasCoApplicant === 'yes' && (
            <div className={styles.formField}>
              <label className={styles.formLabel}>Co-Applicant Monthly Income</label>
              <select
    ...
    <section className={styles.section} ref={ref} id="finance">
      ...
      >
        ...
        <p className={styles.sectionSubtitle}>
          Comprehensive financial planning tools to help you make an informed property investment
          decision
        </p>
          ...
          >
            ...
            {banks.length > initialBankCount && (
              <div className={styles.viewMoreWrap}>
                {!showAllBanks ? (
                  <button className={styles.viewMoreBtn} onClick={() => setShowAllBanks(true)}>
                  ...
                  <button className={styles.viewMoreBtn} onClick={() => setShowAllBanks(false)}>
                  ...
                  <div className={styles.assessmentHeader}>
                    ...
                    <div>
                      ...
                      <p className={styles.assessmentDesc}>
                        Answer a few quick questions to get a personalised financial fit score and
                        expert recommendations for this property worth{' '}
                  ...
                  <form className={styles.assessmentForm} onSubmit={handleAssessmentSubmit}>
                    ...
                    <div className={styles.assessmentSubmitWrap}>
                      ...
                      <p className={styles.privacyNote}>
                        <Icon icon="mdi:lock-outline" /> Your data is secure and used only for this
                        assessment
                      </p>
                      <p
                        style={{
                      ...
                      >
                        ...
                        />
                        This is an indicative tool only. We are not a bank or financial institution.
                        Final eligibility is subject to the bank&apos;s assessment.
                      </p>
                    </div>
                  </form>
                </motion.div>
                  ...
                  <div className={styles.resultCard}>
                    ...
                    <div className={styles.scoreBreakdown}>
                      ...
                      <div className={styles.breakdownGrid}>
                        {(() => {
                          ...
                          const affordableProperty =
                            dp > 0 ? Math.round(eligibleLoan / (1 - dp / 100)) : eligibleLoan;
                          ...
                          const breakdownItems = [
                            ...
                            },
                            {
                              ...
                              sub: assessmentData.emiTenure
                                ? `Remaining tenure: ${assessmentData.emiTenure.replace('24+', '24+')} months`
                                : 'No existing EMIs',
                            },
                            {
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <strong>Disclaimer:</strong> This is an indicative assessment based on the
                        information provided and standard FOIR (Fixed Obligation to Income Ratio)
                        norms used in the Indian real estate industry. We are not a bank, NBFC, or
                        financial institution. Actual loan eligibility, interest rates, and terms
                        are determined solely by the respective lending institution after their
                        independent evaluation. This tool is for informational purposes only and
                        does not constitute financial advice or a loan offer. Please consult with
                        your bank or a certified financial advisor for accurate eligibility.
                      </p>
                    </div>
                ...
                >
                  <div className={styles.thankYouCard}>
                    ...
                    <p className={styles.thankYouText}>
                      Your Financial Fit Assessment has been submitted successfully. Your score of{' '}
                      <strong style={{ color: scoreInfo?.color }}>{fitScore}/100</strong> (
                      {scoreInfo?.label}) has been recorded.
                    </p>
                    <p className={styles.thankYouSubtext}>
                      Our property advisors will reach out to you within 24 hours to help connect
                      you with suitable banks and financing options tailored to your profile for
                      this property.
                    </p>
                    <p
                      style={{
                    ...
                    >
                      <Icon
                        icon="mdi:information-outline"
                        style={{ fontSize: '0.7rem', verticalAlign: 'middle', marginRight: '2px' }}
                      />
                      We are a real estate advisory platform, not a bank or financial institution.
                      All loan-related decisions are made by the respective banks.
                    </p>
            ...
            <div className={styles.emiHeader}>
              ...
              <div>
                ...
                <p className={styles.emiHeaderDesc}>
                  Plan your monthly payments for <strong>{formatCurrency(price)}</strong> property
                </p>
              </div>
            </div>
            ...
            <div className={styles.emiGrid}>
              ...
              <div className={styles.emiResults}>
                ...
                <div className={styles.emiTip}>
                  ...
                  <span>
                    Tip: Increasing your down payment to {Math.min(loanPercent + 5, 90)}% can save
                    you approx. {formatCurrency(totalInterest * 0.08)} in interest over the loan
                    tenure.
                  </span>
                </div>
              </div>
                    ...
                    >
                      <form className={styles.assessmentForm} onSubmit={handleModalSubmit}>
                        ...
                        <div className={styles.assessmentSubmitWrap}>
                          ...
                          <p className={styles.privacyNote}>
                            <Icon icon="mdi:lock-outline" /> Your data is secure and used only for
                            this assessment
                          </p>
                          <p
                            style={{
                          ...
                          >
                            ...
                            />
                            This is an indicative tool only. We are not a bank or financial
                            institution. Final eligibility is subject to the bank&apos;s assessment.
                          </p>
                        </div>
                      </form>
                    </motion.div>
                  ...
                  {modalStep === 1 && modalFitScore !== null && (
                    ...
                    >
                      {(() => {
                        ...
                        const eligibleLoan = computeEligibleLoan(
                          modalFormData,
                          eligibilityModal.bank?.rate || 8.5
                        );
                        return (
                          <div className={styles.eligibilityResult}>
                            ...
                            <p className={styles.eligibilityResultText}>{mScoreInfo.message}</p>
                            <div
                              style={{
                                width: '100%',
                                margin: '12px 0',
                            ...
                            >
                              ...
                              >
                                *Based on {eligibilityModal.bank?.rate || 8.5}% p.a. for 20 years
                                (indicative only)
                              </span>
                            </div>
                            <p className={styles.eligibilityResultSub}>
                              Our team will help connect you with {eligibilityModal.bank.name} for
                              detailed loan processing and final eligibility assessment.
                            </p>
                            <p
                              style={{
                                fontSize: '0.65rem',
                            ...
                            >
                              ...
                              />
                              We are not a bank or financial institution. This is an indicative
                              estimate only. Actual eligibility is determined by{' '}
                              {eligibilityModal.bank.name}.
                            </p>
