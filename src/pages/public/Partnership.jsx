...
const whyPartner = [
  {
    ...
    desc: 'Access our vast network of qualified buyers, investors, and tenants across Bangalore and beyond.',
  },
  {
    icon: 'mdi:chart-line',
    title: 'Market Expertise',
    desc: 'Leverage our deep knowledge of Bangalore real estate market trends, pricing, and demand patterns.',
  },
  {
    icon: 'mdi:bullhorn-outline',
    title: 'Marketing Power',
    desc: 'Benefit from our multi-channel marketing engine — digital campaigns, social media, events, and more.',
  },
  {
    icon: 'mdi:cog-outline',
    title: 'Technology Platform',
    desc: 'Use our advanced CRM, analytics, and property management tools to streamline operations.',
  },
];
...
const partnerTypes = [
  {
    ...
    desc: 'Partner with us to market your residential and commercial projects to our qualified buyer network.',
  },
  {
    icon: 'mdi:badge-account-outline',
    title: 'Real Estate Agents',
    desc: 'Join our agent network for shared inventory access, referral programs, and co-marketing opportunities.',
  },
  {
    icon: 'mdi:bank-outline',
    title: 'Financial Institutions',
    desc: 'Collaborate on home loan solutions, insurance products, and financial advisory services for buyers.',
  },
  {
    icon: 'mdi:palette-outline',
    title: 'Interior Designers',
    desc: 'Connect with homebuyers who need interior design and furnishing services for their new properties.',
  },
];
...
const Partnership = () => {
  return (
    <>
      <Helmet>
        <title>{`Partnership | ${SITE.name}`}</title>
        <meta
          name="description"
          content={`Partner with ${SITE.name}. Builders, agents, financial institutions, and interior designers — grow your business through our extensive network in Bangalore.`}
        />
      </Helmet>
        ...
        <section className={styles.hero}>
          ...
          >
            ...
            <p className={styles.heroSubtitle}>
              Partner with Bangalore's leading real estate advisory firm. Together, we can create
              exceptional value for our clients and grow our businesses.
            </p>
          </motion.div>
        </section>
          ...
          <div className={styles.container}>
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionSubtitle}>
                The advantages of joining the {BRAND.name} ecosystem
              </p>
            </div>
        ...
        <Section className={styles.section}>
          <div className={styles.container}>
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionSubtitle}>
                Trusted by leading brands in real estate and allied industries
              </p>
            </div>
            ...
            <div className={styles.formSection}>
              <div className={styles.formInfo}>
                ...
                <p className={styles.formInfoText}>
                  Interested in partnering with {BRAND.name}? Share your details and our
