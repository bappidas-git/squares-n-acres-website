        ...
        <Paper key={index} sx={{ p: 2, borderRadius: 2, border: '1px solid #E5E7EB' }}>
          ...
          >
            ...
            {formData.floorPlans.length > 1 && (
              <IconButton
                size="small"
                onClick={() => removeListItem('floorPlans', index)}
                sx={{ color: '#EF4444' }}
              >
          ...
          <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap' }}>
            <TextField
              ...
              value={fp.config}
              onChange={(e) =>
                updateListItem('floorPlans', index, { ...fp, config: e.target.value })
              }
              sx={{ flex: '1 1 140px' }}
            ...
            <TextField
              ...
              value={fp.price}
              onChange={(e) =>
                updateListItem('floorPlans', index, { ...fp, price: e.target.value })
              }
              sx={{ flex: '1 1 140px' }}
              InputProps={{
            ...
            <TextField
              ...
              value={fp.bedrooms}
              onChange={(e) =>
                updateListItem('floorPlans', index, { ...fp, bedrooms: e.target.value })
              }
              sx={{ width: 100 }}
            />
            <TextField
              ...
              value={fp.bathrooms}
              onChange={(e) =>
                updateListItem('floorPlans', index, { ...fp, bathrooms: e.target.value })
              }
              sx={{ width: 100 }}
            />
            <Box sx={{ flex: '1 1 100%' }}>
              <TextField
                ...
                value={fp.image}
                onChange={(e) =>
                  updateListItem('floorPlans', index, { ...fp, image: e.target.value })
                }
                fullWidth
