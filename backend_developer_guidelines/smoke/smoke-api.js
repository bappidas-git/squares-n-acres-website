#!/usr/bin/env node
// Generated by `npm run generate:smoke-bundle` from scripts/smoke-api.js — do not edit; edit the source and regenerate.
/**
...
const { allEndpoints } = require('./lib/src/services/endpoints.js');
const schemas = require('./lib/src/services/schemas/index.js');
const {
  TOKEN_FOR,
  WRITABLE,
  groupOf,
  ...
  sampleBody,
  successStatus,
} = require('./lib/scripts/lib/guidelines/fixtures.js');
