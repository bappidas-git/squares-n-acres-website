...
| Pages       | `/admin/pages`                                                                                                                                                                                                                                                                                               |
| FAQs        | `/admin/faqs`                                                                                                                                                                                                                                                                                                |
| Master data | Localities (`/admin/master-data/localities`), Cities (`/admin/master-data/cities`), Property types (`/admin/master-data/property-types`), Amenities (`/admin/master-data/amenities`), Badges (`/admin/master-data/badges`), Developers (`/admin/master-data/developers`), Banks (`/admin/master-data/banks`) |
