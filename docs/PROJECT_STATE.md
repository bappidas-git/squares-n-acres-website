...
Status: IN PROGRESS
Last prompt executed: 12 — Auth, admin shell, RBAC routes, notifications and profile Next prompt: 13
...
| 12  | Auth, admin shell, RBAC routes, notifications and profile     | HEAD of this branch (a commit cannot contain its own hash — prompt 13 fills it in) | 2026-09-16 |
...
| ADD-19 (settings/users) | `AdminSettings`: `PUT` drops `footerLinks`, tab panels out of order, "Footer Tagline" edits the General `tagline`, hardcoded `role === 'admin'`; `UserManagement`: last-admin guard hole, plaintext passwords echoed, own `ROLES` list. **The `AdminLogin` half is closed in 12.**                                                                                                                                                                                                                                                                                         | master spec, confirmed 01                                                                                                                           | 13, 40                                          |
